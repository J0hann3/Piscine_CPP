...
/*   Updated: 2023/12/09 19:40:25 by jvigny           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "Default constructor with string called" << std::endl;
}
...
{
	std::cout << "Set attack damage of " << _name << " to " << attackDamage <<std::endl;
